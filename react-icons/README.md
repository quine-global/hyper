The icons in this folder were taken from the @react-icons/all-files package. The package's original
README.md is included below, as well as its associated LICENSE in this directory.
